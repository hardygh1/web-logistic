...
class ReportesController extends Controller
{
   ...
   ');
         switch ($datos[1]) {
            ...
            case '2':
               $cabecera = $cabecera[0];
               $pdf = \PDF::loadView('paquete.ReciboPdf', compact(['data', 'cabecera']))->setPaper('A4');
            ...
            case '3':
               ...
               $cabecera = $cabecera[0];
               $pdf = \PDF::loadView('paquete.FacturaPdf', compact(['data', 'proveedor', 'fecha', 'cabecera']))->setPaper('A4');
